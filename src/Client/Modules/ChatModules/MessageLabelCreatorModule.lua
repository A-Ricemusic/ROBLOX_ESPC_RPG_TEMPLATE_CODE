-- Message Label Creator Module
-- Username
-- October 5, 2022



local MessageLabelCreatorModule = {}
...
function MessageLabelCreatorModule.new()
...
function MessageLabelCreatorModule:GetStringTextBounds(text, font, textSize, sizeBounds)
	return messageCreatorUtil:GetStringTextBounds(text, font, textSize, sizeBounds)
end



return MessageLabelCreatorModule