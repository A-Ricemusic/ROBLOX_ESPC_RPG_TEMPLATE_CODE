-- Message Log Display Module
-- Username
-- October 5, 2022



local MessageLogDisplayModule = {}
...
local MessageLogDisplayModule = {}
MessageLogDisplayModule.ScrollBarThickness = 4
...
function MessageLogDisplayModule.new()
...
return MessageLogDisplayModule