...
-- Etc
SkeletonConfigModule.FollowDistance = 10
...
SkeletonConfigModule.ATTACK_STAND_TIME = 0.8
SkeletonConfigModule.HITBOX_SIZE = Vector3.new(5, 3, 5)
SkeletonConfigModule.SEARCH_DELAY = 1
SkeletonConfigModule.ATTACK_RANGE = 5
SkeletonConfigModule.ATTACK_DELAY = 1
